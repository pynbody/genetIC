...
template<typename T>
void HDFReadSelect(const std::string Filename, const std::string ObjName, const std::vector<unsigned> &ii,
                   std::vector<T> &Data) {
...
template<typename T>
void HDFReadVectorSelect(const std::string Filename, const std::string ObjName, const std::vector<unsigned> &ii,
                         std::vector<T> &Data) {
...
//  hsize_t HDF_StorageSize;
  ...
  if (H5Sselect_elements(HDF_DataspaceID, H5S_SELECT_SET, coord.size() / 2, (const hsize_t *) &coord[0]) <
      0)//(const hsize_t**)&coord[0] ) < 0 )
...
template<typename T>
void HDFReadVectorSlab(const std::string Filename, const std::string ObjName, unsigned nStart, unsigned nCount,
                       std::vector<T> &Data) {
  hsize_t
    offset[2],
    stride[2],
...
template<typename T>
void HDFReadDatasetSlab(const std::string Filename, const std::string ObjName, unsigned nStart, unsigned nCount,
                        std::vector<T> &Data) {
  hsize_t
    offset[2],
    stride[2],
...
template<typename T>
void HDFReadGroupAttribute(const std::string Filename, const std::string GroupName, const std::string ObjName,
                           T &Data) {
  ...
  if (HDF_FileID < 0 || HDF_GroupID < 0 || HDF_AttributeID < 0) {
    std::stringstream ss;
    ss << " - Warning: attribute \'" << GroupName.c_str() << "/" << ObjName.c_str() <<
...
template<typename T>
void HDFWriteDataset2D(const std::string Filename, const std::string ObjName,
...
template<typename T>
void HDFWriteGroupAttribute(const std::string Filename, const std::string GroupName, const std::string ObjName,
...
template<>
void HDFWriteGroupAttribute<std::string>(const std::string Filename, const std::string GroupName,
                                         const std::string ObjName, std::string Data) {
