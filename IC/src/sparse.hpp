...
template<typename MyFloat>
void mat_mat_diag(const std::complex<MyFloat> *z, const std::complex<MyFloat> *alpha, const long int n,
                  const std::complex<MyFloat> p, std::complex<MyFloat> *result) {
  long int i;
...
template<typename MyFloat>
void mat_sum(const std::complex<MyFloat> *C1, const std::complex<MyFloat> *C2, const long int n,
             const std::complex<MyFloat> p, std::complex<MyFloat> *result) {
